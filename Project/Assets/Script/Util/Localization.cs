...
static public class Localization
{
    ...
    static string mLanguage = "English";
	...
	static public string Language
	{
		...
		set
		{
			if (mLanguage != value)
			{
				mLanguage = value;
				LoadAndSelect(value);
                //TimeUtil.OnLanguageChanged();
			}
		}
	}
	//static public int LanguageIndex { get { return mLanguageIndex; } }
	...
	static public bool Reload ()
	{
		...
		//UIManager.Instance.Broadcast("OnLocalize");
		return true;
	}
	...
	static void LoadFont(string value)
	{
		// NGUIFont mainFont = Resources.Load(DefsUI.FontPath.MAIN_FONT_PREFAB) as NGUIFont;
		// if(mainFont == null)
		// {
		// 	return;
		// }
		...
		// if(mainFont.dynamicFont != null)
		// {
		// 	Resources.UnloadAsset(mainFont.dynamicFont);
		// }

		// Font font = null;
		// if(value.Equals(SystemLanguage.Japanese.ToString()))
		// {
		// 	font = Resources.Load(DefsUI.FontPath.JAPANESE) as Font;
		// }
		// else
		// {
		// 	font = Resources.Load(DefsUI.FontPath.BASE) as Font;
		// }
		// if(font == null)
		// {
		// 	return;
