...
{
    [CanEditMultipleObjects, CustomEditor(typeof(TabButton), false)]
    public class TabButtonEditor : Editor
    {
        ...
        private static List<TabButtonEditor> s_Editors = new List<TabButtonEditor>();
        private static bool s_ShowNavigation = false;
        private static string s_ShowNavigationKey = "TabButtonEditorEditor.ShowNavigation";

        // Whenever adding new SerializedProperties to the Selectable and TabButtonEditorEditor
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorList.Show(base.serializedObject.FindProperty("_initialState"));
            EditorList.Show(base.serializedObject.FindProperty("_stateObjList"));
            //EditorList.Show(base.serializedObject.FindProperty("_stateCallbackList")); // To be UnityEvent
