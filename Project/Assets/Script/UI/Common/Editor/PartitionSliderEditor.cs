...
{
    [CanEditMultipleObjects, CustomEditor(typeof(PartitionSlider), false)]
    public class PartitionSliderEditor : Editor
    {
        ...
        private static List<PartitionSliderEditor> s_Editors = new List<PartitionSliderEditor>();
        private static bool s_ShowNavigation = false;
        private static string s_ShowNavigationKey = "PartitionSliderEditorEditor.ShowNavigation";

        // Whenever adding new SerializedProperties to the Selectable and PartitionSliderEditorEditor
        ...
        protected virtual void OnEnable()
        {
            ...
            m_ShowColorTint.valueChanged.RemoveAllListeners();
            m_ShowSpriteTrasition.valueChanged.RemoveAllListeners();
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorList.Show(base.serializedObject.FindProperty("m_FillRect"));
            EditorList.Show(base.serializedObject.FindProperty("m_HandleRect"));
            EditorList.Show(base.serializedObject.FindProperty("m_Direction"));
            EditorList.Show(base.serializedObject.FindProperty("m_MinValue"));
            EditorList.Show(base.serializedObject.FindProperty("m_MaxValue"));
            EditorList.Show(base.serializedObject.FindProperty("m_WholeNumbers"));
            EditorList.Show(base.serializedObject.FindProperty("m_Value"));
            EditorList.Show(base.serializedObject.FindProperty("m_OnValueChanged"));

            EditorList.Show(base.serializedObject.FindProperty("_fillArea"));
            EditorList.Show(base.serializedObject.FindProperty("_partitionRoot"));
            EditorList.Show(base.serializedObject.FindProperty("_partitionPrefab"));
