...
{
    [CanEditMultipleObjects, CustomEditor(typeof(InteractableButton), false)]
    public class InteractableButtonEditor : Editor
    {
        ...
        private static List<InteractableButtonEditor> s_Editors = new List<InteractableButtonEditor>();
        private static bool s_ShowNavigation = false;
        private static string s_ShowNavigationKey = "InteractableButtonEditorEditor.ShowNavigation";

        // Whenever adding new SerializedProperties to the Selectable and InteractableButtonEditorEditor
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorList.Show(base.serializedObject.FindProperty("_onPointDownEvent"));
            EditorList.Show(base.serializedObject.FindProperty("_stateObjList"));
            EditorList.Show(base.serializedObject.FindProperty("m_OnClick"));
